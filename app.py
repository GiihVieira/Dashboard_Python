...
st.set_page_config(layout='wide') # Configura o layout da tela do streamlit
st.title("Dashboard de Vendas :shopping_trolley:") # Titulo da tela do dashboard e adiciona um emojin
...
aba1 , aba2, aba3 = st.tabs(['Dataset', 'Receita', 'Vendedores']) # Cria as janelas (tabs)
